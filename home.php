...
<div class="container">
  ...
  <a class="col-sm-2"href="services.php"style="color: black;">>Our Services</a>>Home Moving Services
</div></div>
<hr style="">
 ...
 <div class="row">
   ...
   <a href="services.php" class="list-group-item">
    All Services</a>
                            ...
                            <a href="home.php"class="list-group-item active">Domestic and inter-county Moving</a>
                            <a href="office.php"class="list-group-item">Office Moving and Relocation</a>
                            <a href="settling.php"class="list-group-item">SettlingServices</a>
                            ...
                            <a href="services.php"class="list-group-item ">Warehousing And Storage Services</a>
...
<div class="col-lg-8">
  <img style="width:650px;height: 500px;"src="img/37.jpg"><br><br>
  <div class="col">
